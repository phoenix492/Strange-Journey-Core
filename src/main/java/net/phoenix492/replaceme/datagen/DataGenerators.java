package net.phoenix492.replaceme.datagen;

import net.phoenix492.replaceme.datagen.client.ModBlockstateProvider;
import net.phoenix492.replaceme.datagen.client.ModItemModelProvider;
import net.phoenix492.replaceme.datagen.client.ModLanguageProvider;
import net.phoenix492.replaceme.datagen.client.ModParticleDescriptionProvider;
import net.phoenix492.replaceme.datagen.client.ModSoundDefinitionsProvider;
import net.phoenix492.replaceme.datagen.server.ModDatapackProvider;
import net.phoenix492.replaceme.datagen.server.ModTagProviders;
